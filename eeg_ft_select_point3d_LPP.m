function [selected] = eeg_ft_select_point3d_LPP(bnd, varargin)
...
%% 
set(groot,'PointerLocation',[LPA(2),a-LPA(1)]);
...
set(groot,'PointerLocation',[LPA(1),a-LPA(2)]);
%% *****************************************************************************************************************************
%while ~done
